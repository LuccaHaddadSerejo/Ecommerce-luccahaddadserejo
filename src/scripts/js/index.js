...
function renderizarCarrinho(lista) {
  if (lista.length == 0) {
    ...
    divCarrinho_1.classList.add(
      "section_aside_div_carrinhoCompras_div_quantidade"
    );
    divCarrinho_1_p.classList.add(
      "section_aside_div_carrinhoCompras_div_quantidade_paragraph"
    );
    divCarrinho_1_span.classList.add(
      "section_aside_div_carrinhoCompras_div_quantidade_number"
    );
    divCarrinho_2.classList.add("section_aside_div_carrinhoCompras_div_total");
    divCarrinho_2_p.classList.add(
      "section_aside_div_carrinhoCompras_div_total_paragraph"
    );
    divCarrinho_2_span.classList.add(
      "section_aside_div_carrinhoCompras_div_total_number"
    );
  ...
  for (let i = 0; i < lista.length; i++) {
    ...
    listButton.addEventListener("click", function AdicionarCarrinho() {
      ...
      if (divCarrinho_2_span.innerHTML == 0) {
        divCarrinho_2_span.innerHTML = `R$ ${
          +divCarrinho_2_span.innerHTML + lista[i].value
        },00`;
      } else {
        divCarrinho_2_span.innerHTML = `R$ ${
          +divCarrinho_2_span.innerHTML.replace("R$ ", "").replace(",00", "") +
          lista[i].value
        },00`;
      }
